...
A job application tracking system with automated message generation, OCR processing, and multi-channel support (WhatsApp, Email).
...
- Job message extraction and classification (Backend / Frontend / Fullstack)
- OCR support for image-based job postings
- Automated message generation with template placeholders
- Multi-channel: WhatsApp link generation, Email delivery, Manual review
